...
The brain is not just a passive filter waiting for stimuli. It is a deeply dynamic, nonlinear, and recurrent information-processing system. The task of deciphering this system is challenging, involving a multitude of scales, mechanisms, and interactions but that is also what makes it worthwhile.
...
4. Doerig, A., Sommers, R. P., Seeliger, K., Richards, B., Ismael, J., Lindsay, G. W., Kording, K. P., Konkle, T., van Gerven, M. A. J., Kriegeskorte, N., & Kietzmann, T. C. (2023). The neuroconnectionist research programme. *Nature Reviews Neuroscience, 24*(7), 431–450. [https://doi.org/10.1038/s41583-023-00705-w](https://doi.org/10.1038/s41583-023-00705-w)
...
6. Hubel, D. H., & Wiesel, T. N. (1959). Receptive fields of single neurones in the cat's striate cortex. *The Journal of Physiology, 148*(3), 574–591. [https://doi.org/10.1113/jphysiol.1959.sp006308](https://doi.org/10.1113/jphysiol.1959.sp006308)
...
11. Marchetti, G. L., Hillar, C., Kragic, D., & Sanborn, S. (2024). Harmonics of learning: Universal Fourier features emerge in invariant networks. In *Proceedings of the Thirty-Seventh Conference on Learning Theory* (Proceedings of Machine Learning Research, Vol. 247, pp. 3775–3797). [https://proceedings.mlr.press/v247/marchetti24a.html](https://proceedings.mlr.press/v247/marchetti24a.html)
...
18. Jones, J. P., & Palmer, L. A. (1987). An evaluation of the two-dimensional Gabor filter model of simple receptive fields in cat striate cortex. *Journal of Neurophysiology, 58*(6), 1233–1258. [https://doi.org/10.1152/jn.1987.58.6.1233](https://doi.org/10.1152/jn.1987.58.6.1233)
